...
const Feeds = () => {
  const { userId } = auth();
  const [result, setResult] = useState({ questions: [], isNext: false });
      ...
      <>
          ...
          <div className="mt-10 flex w-full flex-col gap-6">
              {result.questions.length > 0 ? (
                  ...
                  <NoResult title="There’s no question to show" description="Be the first to break the silence! 🚀 Ask a Question and kickstart the discussion. our query could be the next big thing others learn from. Get involved! 💡" link="/ask-question" linkTitle="Ask a Question"/>
              )}
          </div>
          <div className="mt-10">
