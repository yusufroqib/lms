...
export const ClosedCaptions = () => {
    ...
    useEffect(() => {
        ...
        return call.on('call.closed_caption', (e) => {
            if (e.type !== 'call.closed_caption')
                return;
            if (e.closed_caption.text.trim() === '')
                return;
    ...
    return (<div className="rd__closed-captions">
      {queue.map(({ speaker_id, text }, index) => (<p className="rd__closed-captions__line" key={speaker_id + index + text}>
...
export const ClosedCaptionsSidebar = () => {
    ...
    return (<div className="rd__closed-captions-sidebar">
