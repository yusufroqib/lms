...
import { DeviceSelectorVideo, Icon, MenuToggle, MenuVisualType, useCallStateHooks, useI18n, } from '@stream-io/video-react-sdk';
const ToggleMenuButton = forwardRef(function ToggleMenuButton(props, ref) {
    ...
    return (<button ref={ref} className="rd__button rd__button--align-left rd__lobby__camera-button">
