...
const upload = multer();
const {createUsername, updateSignature, loggedInUser, videocall, becomeTutor, updateProfile, changePassword } = require("../controllers/userController");
const verifyJWT = require("../middleware/verifyJWT");
const router = express.Router();

router.get("/me", verifyJWT, loggedInUser);
router.put("/username", verifyJWT, createUsername);
router.put("/signature", verifyJWT, updateSignature);
